(function ($) {
  ...
  function updateLightboxImage(options) {
    ...
    function getPreviousIndex(currentIndex, arrayLength) {
    ...
    $(".mg-prev").on("click", function () {
      currentImageIndex = getPreviousIndex(currentImageIndex, categories[currentCategory].length);
      updateLightboxImage(options.navigation);
  });
    $(".mg-next").on("click", function () {
      currentImageIndex = getNextIndex(currentImageIndex, categories[currentCategory].length);
      updateLightboxImage(options.navigation);
    });
}
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      ...
      $("img.gallery-item").each(function () {
        if ($(this).attr("src") === $(".carousel-item.active img").attr("src")) {
          activeImage = $(this);
        }
      });
